...
MapTo('wknd-spa-angular/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('wknd-spa-angular/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
...
LazyMapTo('wknd-spa-angular/components/teaser')(TeaserV1Component);
...
LazyMapTo('wknd-spa-angular/components/carousel')(CarouselV1Component);
...
LazyMapTo('wknd-spa-angular/components/text')(LazyTextModule, TextEditConfig);